                            ...
                            <div className="w-full px-4">
                                <div className="flex justify-between items-center mb-4">
                                    ...
                                    <div className="space-x-2">
                                        ...
                                        ${viewType === 'grid' ? 'bg-blue-600 text-white' : 'bg-gray-500 hover:bg-gray-600 text-white'}`}
                                        >
                                            Grid
                                        </button>
                                        <button
                                            ...
                                            className={`py-2 px-6 rounded-lg shadow-md 
                                        ${viewType === 'table' ? 'bg-blue-600 text-white' : 'bg-gray-500 hover:bg-gray-600 text-white'}`}
                                        >
                                            Table
                                        </button>
                                    </div>
                                            ...
                                            <tbody>
                                                {filteredItems.map((item, idx) => (
                                                    <tr key={idx} className="border-b even:bg-gray-100">
                                                        ...
                                                        <td className="p-2">
                                                            <img src={item.img} alt={item.name} className="h-20 mx-auto" />
                                                        </td>
                                                        <td className="p-2">
                                                        ...
                                                        <Link to={`/items/${filteredItems[filteredItems.length - 1].id}`}>
